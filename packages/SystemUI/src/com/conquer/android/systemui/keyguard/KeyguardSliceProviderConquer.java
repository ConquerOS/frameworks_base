package com.conquer.android.systemui.keyguard;
...
public class KeyguardSliceProviderConquer extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderConquer> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderConquer keyguardSliceProviderConquer, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderConquer);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderConquer.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderConquer keyguardSliceProviderConquer;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderConquer = (KeyguardSliceProviderConquer) mProviderReference.get();
            }
            if (keyguardSliceProviderConquer != null) {
                keyguardSliceProviderConquer.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderConquer#onBindSlice");
        Slice slice;
